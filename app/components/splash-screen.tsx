      ...
      {isVisible && (
        ...
        >
          ...
          <motion.div
            ...
            transition={{ scale: { duration: 0.8, ease: "easeOut" }, opacity: { duration: 0.6 } }}
          ...
          <div className="relative flex flex-col items-center z-10">
            ...
            >
              ...
              >
                <motion.div
                  initial={{ x: "-120%" }}
                  animate={{ x: ["-120%", "220%"] }}
                  transition={{ duration: 1.2, delay: 0.3, repeat: Infinity, repeatDelay: 0.8, ease: "easeInOut" }}
            ...
            {/* Haute Marketplace text and gold progress line */}
            <motion.div
